...
public:
    ...
    bool tryGetStarIndex(uint16_t targetCol, uint8_t targetRow, uint8_t& outIndex) const;
...
private:
    ...
    bool checkCollisionAt(fx shipY);
    bool starOverlapsShip(gv::fx shipX, gv::fx shipY, gv::fx centerX, gv::fx centerY) const;
...
private:
    ...
    // Difficulty
    Difficulty difficulty_ = Difficulty::Rookie;
    fx scrollSpeed_{};
    fx flyOutSpeed_{};
