...
public:
    ...
    void buildHud(RenderList& rl, const Game& game) const;
    void buildStatusOverlay(RenderList& rl, const StatusOverlay& overlay) const;
...
private:
    ...
    void addText(RenderList& rl, const Text& text, int16_t x, int16_t y,
                 ...
                 uint16_t bgColor565 = 0x0000, uint8_t styleFlags = TextStyle::None) const;
...
private:
    ...
    void trailDraw(RenderList& rl, fx scrollX, uint16_t color) const;
};
